package br.edu.infnet.lessonservice.controller;
...
public class LessonController {
    ...
    public ResponseEntity<Lesson> createLesson(@RequestBody Lesson lesson) {
        Teacher teacher = teacherService.getTeacherById(lesson.getTeacherId());
        if (teacher == null) {
            throw new TeacherNotFoundException("Nenhum professor encontrado para o ID: " + lesson.getTeacherId());
        }
    ...
    public ResponseEntity<List<Lesson>> getAllLessonsByTeacher(@PathVariable  String id) {
    ...
    public ResponseEntity<Map<String, String>> deleteLessonById(@PathVariable String id) {
